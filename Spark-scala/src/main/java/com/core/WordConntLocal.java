...
public class WordConntLocal {
    public static void main(String[] args) {
        ...
        JavaRDD<String> lines = sc.textFile("hdfs://172.16.104.203:9000/home/sqoop/employee1000w/part-m-00000");
        ...
        JavaRDD<String> words = lines.flatMap(new FlatMapFunction<String, String>() {
            ...
            public Iterator<String> call(String s) throws Exception {
                ...
                return Arrays.asList(split[1]).iterator();
            }
        });
...
//        });
        ...
        wordCounts.saveAsTextFile("hdfs://bigdata3:9000/SparkOut/day01.2");
