package com.gpdi.hadoop.module.reduce.service;

import com.gpdi.hadoop.module.util.HdfsUtil;
import com.gpdi.hadoop.module.util.ReduceJobsUtils;
...
public class MapReduceService {
     ...
     * @throws Exception
     */
    public void polluteCountCount(String jobName, String inputPath) throws Exception {
        ...
        ReduceJobsUtils.getPolluteCountJobsConf(jobName, inputPath, outputPath);
    }
    /**
     * 单词统计，统计某个单词出现的次数
     *
